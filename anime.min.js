...
!(function (n, e) {
  ...
  var H = function (b, e, M, t) {
    if (0 <= b && b <= 1 && 0 <= M && M <= 1) {
      ...
      if (b !== e || M !== t) for (var n = 0; n < 11; ++n) x[n] = k(0.1 * n, b, M);
      return function (n) {
    ...
    function r(n) {
      ...
      for (
        ...
        0 < (l = k((d = h + (g - h) / 2), m, v) - p) ? (g = d) : (h = d), 1e-7 < Math.abs(l) && ++y < 10;
    ...
    Object.keys(t).forEach(function (n) {
      ...
      (e["easeIn" + n] = r),
        ...
        (e["easeOutIn" + n] = function (e, t) {
          return function (n) {
            return n < 0.5 ? (1 - r(e, t)(1 - 2 * n)) / 2 : (r(e, t)(2 * n - 1) + 1) / 2;
          };
        });
    });
  var e,
  ...
  function p(n) {
    return w.arr(n)
      ? n
      : (n = w.str(n) ? a(n) || n : n) instanceof NodeList || n instanceof HTMLCollection
      ? [].slice.call(n)
      : [n];
  }
  function h(n, e) {
  ...
  function V(n) {
    ...
    return w.rgb(n)
      ? (e = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec((t = n)))
        ...
        : t
      : w.hex(n)
      ? ((e = (e = n).replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (n, e, t, r) {
          return e + e + t + t + r + r;
        })),
        (e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e)),
        "rgba(" + parseInt(e[1], 16) + "," + parseInt(e[2], 16) + "," + parseInt(e[3], 16) + ",1)")
      : w.hsl(n)
      ? ((t =
        ...
        0 == u
          ? (r = a = o = i)
          : ((r = c((u = 2 * i - (i = i < 0.5 ? i * (1 + u) : i + u - i * u)), i, n + 1 / 3)),
            (a = c(u, i, n)),
            (o = c(u, i, n - 1 / 3))),
      ...
      : ((r = l.CSS[e + t]),
        w.und(r)
          ? ((a = document.createElement(n.tagName)),
            (n = n.parentNode && n.parentNode !== document ? n.parentNode : document.body).appendChild(a),
  ...
  function X(n, e, t, r) {
    var a = u(e, "scale")
        ? 1
        : 0 + (u((a = e), "translate") || "perspective" === a ? "px" : u(a, "rotate") || u(a, "skew") ? "deg" : void 0),
      o = W(n).get(e) || a;
  ...
  function Y(n, e) {
    ...
    return w.col(n)
      ...
      : /\s/g.test(n)
      ? n
      : ((t = (t = B(n)) ? n.substr(0, n.length - t.length) : n), e ? t + e : t);
  }
  function F(n, e) {
  ...
  function L(n) {
    ...
    function u(n) {
      ...
      !k.began && 0 < k.currentTime && ((k.began = !0), b("begin")),
        !k.loopBegan && 0 < k.currentTime && ((k.loopBegan = !0), b("loopBegin")),
        a <= t && 0 !== k.currentTime && y(0),
        ((r <= a && k.currentTime !== e) || !e) && y(e),
        t < a && a < r
          ? (k.changeBegan || ((k.changeBegan = !0), (k.changeCompleted = !1), b("changeBegin")), b("change"), y(a))
          : k.changeBegan && ((k.changeCompleted = !0), (k.changeBegan = !1), b("changeComplete")),
        ...
        e <= n &&
          ...
          k.remaining
            ? ((s = l), b("loopComplete"), (k.loopBegan = !1), "alternate" === k.direction && g())
            : ((k.paused = !0),
              k.completed ||
                ((k.completed = !0),
                b("loopComplete"),
